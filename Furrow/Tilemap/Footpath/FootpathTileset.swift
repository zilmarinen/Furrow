...
extension FootpathTileset {
    ...
    func read(fileWrapper: FileWrapper) throws {
        ...
        let jsonFilename = Document.Constants.Folder.footpath + "_" + Document.Constants.Filename.tilemap + "." + Document.Constants.FileFormat.json
        ...
        let nodes = try decoder.decode([FootpathTile].self, from: jsonData)

        for node in nodes {

            let imageFilename = "\(node.tileType.description)_\(node.pattern)_\(node.variation)." + Document.Constants.FileFormat.png
    ...
    func export() throws -> FileWrapper {
        ...
        let imageFilename = Document.Constants.Folder.footpath + "_" + Document.Constants.Filename.tileset + "." + Document.Constants.FileFormat.png
        let jsonFilename = Document.Constants.Folder.footpath + "_" + Document.Constants.Filename.tilemap + "." + Document.Constants.FileFormat.json
